...
def plot_images(images, epoch):
    ...
    plt.tight_layout()
    path = './output/3/' + str(epoch) + '.jpg'
    plt.savefig(path)
    plt.show()
    plt.close()

plot_images(trainset[:25], 0)
...
for epoch in range(max_epoch):
    ...
    if (epoch%15 == 1): plot_images(f_images[:25], epoch)
...
# show 
plt.plot(ep, real, label='Accuracy', color=(255/255,100/255,100/255))
plt.plot(ep, fake, '--', label='Fake', color=(100/255,100/255,255/255))

# lines = plt.plot(ep,real,ep,fake)
plt.xlabel("Epochs")
plt.ylabel("Accuracy")
plt.legend()
# plt.show()
...
plt.plot(ep, dloss, label='d_loss', color=(255/255,100/255,100/255))
plt.plot(ep, gloss, label='g_loss', color=(100/255,100/255,255/255))
plt.xlabel("Epochs")
plt.ylabel("Loss")
plt.legend()
